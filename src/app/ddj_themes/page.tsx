      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="w-full min-h-screen bg-neutral-50 p-8 font-serif">
          ...
          <div className="bg-white mt-8 p-6 rounded-lg shadow-md border-l-4 border-teal-700">
            ...
            常 (cháng) - &ldquo;Constant,&rdquo; &ldquo;eternal,&rdquo; &ldquo;unchanging,&rdquo; or &ldquo;in accordance with natural law.&rdquo; It is a key concept in Daoism, emphasizing the unchanging flow of the Dao.
          </div>
          <div className="bg-white mt-8 p-6 rounded-lg shadow-md border-l-4 border-teal-700">
